      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.restaurantSection}>
          ...
          <View style={styles.restaurantMainInfo}>
            ...
            <Text style={[styles.restaurantCategory, styles.baseText]}>Categoria: {restaurant.category}</Text>
            <TouchableOpacity 
              style={styles.orderRestaurantButton}
              onPress={() => navigation.navigate('OrderForm', { item: restaurant, type: 'restaurant' })}
            >
              <Text style={[styles.orderRestaurantButtonText, styles.baseText]}>Fazer Pedido do Restaurante</Text>
            </TouchableOpacity>
          </View>
        </View>
